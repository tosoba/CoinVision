...
extension Chart: MessageHandlerDelegate {
    func messageHandler(_: MessageHandler,
    ...
    func messageHandler(_: MessageHandler,
                        didReceiveVisibleTimeRangeChangeWithParameters _: TimeRange?) {}

    func messageHandler(_: MessageHandler,
                        didReceiveVisibleLogicalRangeChangeWithParameters _: LogicalRange?) {}

    func messageHandler(_: MessageHandler,
                        didReceiveTimeScaleSizeChangeWithParameters _: Rectangle?) {}
}
